...
public class Profile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print(" h1{  margin-left: 13px; padding: 0 30px; margin-top: 5px; }");	 
	   ...
	   out.print(" a:hover,  .active a{color: sandybrown;}");		   		 
        ...
        out.print("<li class = 'active'><a href = 'prof'>Profile</a></li>");  
		...
		out.print("<h2 style = 'color:maroon; text-align:center; font-size:35px;'>Welcome to Profile Page</h2>");
		...
		RequestDispatcher rd1 = request.getRequestDispatcher("about");
